...
| "Ontab" | `font-display`, 100px, weight 520, track −0.02em, line-height 1, `--headline` |
| Headline | `font-display`, 18px, weight 450, track −0.02em, line-height 1.2, `--ink-strong`; **7px** below "Ontab" (reads as its subtitle) |
