...
| "Ontab" | `font-display`, 112px, weight 520, track −0.02em, line-height 1, `--headline` |
| Headline | `font-display`, 21px, weight 450, track −0.02em, line-height 1.2, `--ink-strong`; 12px below "Ontab" |
| Benefit row | 15px below the headline |
