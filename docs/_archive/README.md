...
- `DESIGN.md` (루트 — 디자인 정본, Google DESIGN.md 표준, ADR-0003/0004)
- `docs/adr/` (결정 이력)
...
- `design.md` (silver 시대 디자인 구현 contract, 2026-06 보관) — 모노크롬 재설계로 대체됨(ADR-0004). 디자인 정본은 루트 `DESIGN.md`. 내부 상대경로 링크는 이동 전(docs/design.md) 기준이라 깨져 있음 — 박제물이라 그대로 둠.
